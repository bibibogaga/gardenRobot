...
if(livox_relocalization_CONFIG_INCLUDED)
  return()
endif()
set(livox_relocalization_CONFIG_INCLUDED TRUE)

# set variables for source/devel/install prefixes
if("TRUE" STREQUAL "TRUE")
  set(livox_relocalization_SOURCE_PREFIX /home/yoga/my_work/catkin_yoga/src/TX2_StereoSLAM-master/src/loam_only/loam_only_relocal/src/livox_relocalization-master)
  set(livox_relocalization_DEVEL_PREFIX /home/yoga/my_work/catkin_yoga/src/TX2_StereoSLAM-master/src/loam_only/loam_only_relocal/devel)
  set(livox_relocalization_INSTALL_PREFIX "")
  set(livox_relocalization_PREFIX ${livox_relocalization_DEVEL_PREFIX})
else()
  set(livox_relocalization_SOURCE_PREFIX "")
  set(livox_relocalization_DEVEL_PREFIX "")
  set(livox_relocalization_INSTALL_PREFIX /home/yoga/my_work/catkin_yoga/src/TX2_StereoSLAM-master/src/loam_only/loam_only_relocal/install)
  set(livox_relocalization_PREFIX ${livox_relocalization_INSTALL_PREFIX})
endif()

# warn when using a deprecated package
if(NOT "" STREQUAL "")
  set(_msg "WARNING: package 'livox_relocalization' is deprecated")
...
set(livox_relocalization_FOUND_CATKIN_PROJECT TRUE)
...
if(NOT "/usr/include/eigen3;/usr/include/pcl-1.8;/usr/include;/usr/include/ni;/usr/include/openni2;/usr/include/vtk-6.3;/usr/include/freetype2;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent;/usr/lib/x86_64-linux-gnu/openmpi/include/openmpi/opal/mca/event/libevent2022/libevent/include;/usr/lib/x86_64-linux-gnu/openmpi/include;/usr/include/python2.7;/usr/include/x86_64-linux-gnu;/usr/include/hdf5/openmpi;/usr/include/libxml2;/usr/include/jsoncpp;/usr/include/tcl;/usr/local/include;/usr/local/include/opencv " STREQUAL " ")
  set(livox_relocalization_INCLUDE_DIRS "")
...
foreach(library ${libraries})
  ...
  elseif(${library} MATCHES "^-")
    ...
    list(APPEND livox_relocalization_LIBRARIES "${interface_target_name}")
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/yoga/my_work/catkin_yoga/src/TX2_StereoSLAM-master/src/loam_only/loam_only_relocal/devel/lib;/usr/local/lib;/home/yoga/desk/projects/try_practice/practice_tf/devel/lib;/home/yoga/Documents/catkin_ws/devel/lib;/opt/ros/melodic/lib)
    ...
    endforeach()
    if(lib)
      _list_append_unique(livox_relocalization_LIBRARY_DIRS ${lib_path})
      list(APPEND livox_relocalization_LIBRARIES ${lib})
    else()
      # as a fall back for non-catkin libraries try to search globally
      find_library(lib ${library})
      if(NOT lib)
        message(FATAL_ERROR "Project '${PROJECT_NAME}' tried to find library '${library}'.  The library is neither a target nor built/installed properly.  Did you compile project 'livox_relocalization'?  Did you find_package() it before the subdirectory containing its code is included?")
      endif()
      list(APPEND livox_relocalization_LIBRARIES ${lib})
    endif()
  endif()
...
set(livox_relocalization_EXPORTED_TARGETS "")
# create dummy targets for exported code generation targets to make life of users easier
foreach(t ${livox_relocalization_EXPORTED_TARGETS})
  if(NOT TARGET ${t})
    add_custom_target(${t})
  endif()
endforeach()
...
foreach(depend ${depends})
  ...
  list(GET depend_list 0 livox_relocalization_dep)
  list(LENGTH depend_list count)
  if(${count} EQUAL 1)
    # simple dependencies must only be find_package()-ed once
    if(NOT ${livox_relocalization_dep}_FOUND)
      find_package(${livox_relocalization_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${livox_relocalization_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
  _list_append_unique(livox_relocalization_INCLUDE_DIRS ${${livox_relocalization_dep}_INCLUDE_DIRS})

  # merge build configuration keywords with library names to correctly deduplicate
  _pack_libraries_with_build_configuration(livox_relocalization_LIBRARIES ${livox_relocalization_LIBRARIES})
  _pack_libraries_with_build_configuration(_libraries ${${livox_relocalization_dep}_LIBRARIES})
  _list_append_deduplicate(livox_relocalization_LIBRARIES ${_libraries})
  # undo build configuration keyword merging after deduplication
  _unpack_libraries_with_build_configuration(livox_relocalization_LIBRARIES ${livox_relocalization_LIBRARIES})

  _list_append_unique(livox_relocalization_LIBRARY_DIRS ${${livox_relocalization_dep}_LIBRARY_DIRS})
  list(APPEND livox_relocalization_EXPORTED_TARGETS ${${livox_relocalization_dep}_EXPORTED_TARGETS})
endforeach()

set(pkg_cfg_extras "")
foreach(extra ${pkg_cfg_extras})
  if(NOT IS_ABSOLUTE ${extra})
    set(extra ${livox_relocalization_DIR}/${extra})
  endif()
  include(${extra})
endforeach()
